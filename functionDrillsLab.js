...
//CODE HERE
jsNinja = () => console.log('I am  JavaScript Ninja!')
jsNinja()
...
const buyFrogs = (amountGold) => {
  amountGold = amountGold / 3
  return amountGold
}
...
//CODE HERE
const buyFrogs2 = (amountGold) => {
  amountGold = (amountGold / 3) - ((amountGold % 3) / 3)
  return amountGold
}
...
//CODE HERE
let arrayIsAscending = false
let testNum = 0
const arrayIsAscendingfunction = (arr) => {
  for( i = 0; i < arr.length; i++) {
    testNum = arr[i]
    if (arr[i] <= testNum ) {
...
arrayIsAscendingfunction(sampleArray)
...
let bathroomScope = []
bathroom()
bathroomScope.push(duck, rubberDuck, sailorDuck)

//This array should contain the variable names (as strings) accessible in the bathtub function.
let bathtubScope = []
bathtubScope.push(duck, sailorDuck)
